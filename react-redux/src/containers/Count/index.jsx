...
import {Flex, Select, Button, Space} from "antd";
...
class CountUI extends Component {
    ...
    OnState = (number) => {
        ...
        number === 1 ? this.props.increment(value * 1) :
            number === 2 ? this.props.decrement(value * 1) :
                number === 3 ? this.props.count % 2 !== 0 && this.props.increment(value * 1) :
    ...
    render() {
        return (
            <div>
                <h1>我是Count组件,下方的组件人数为：{this.props.person}</h1>
