...
export default class Count extends Component {
    ...
    OnState = (value) => {
        ...
        value === 1 ? this.props.Addition(change * 1) :
            value === 2 ? this.props.Subtraction(change * 1) :
                value === 3 ? this.props.count % 2 !== 0 && this.props.Addition(change * 1) :
                    this.props.OddNumberAddition(change * 1, 500);
    };
